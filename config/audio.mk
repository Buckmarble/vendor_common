ALARM_PATH := vendor/common/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/common/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/common/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/common/prebuilt/common/media/audio/ui
